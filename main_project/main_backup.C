...
int main(int argc, char **argv)
{
    ...
    const char *filename = (argc > 1) ? argv[1] : "data/20260818_test_multiple_sigma4_mpr_2.root";
    ...
    int N = std::min(Reff_Spectrum.size(), fitted_means.size());

    linearityAnalyzer.compute_R_2(N, a, b, fitted_means, reff_means);
